...
if(isset($_GET['post']))
{
	$action = $_GET['action'];
	$id = $_GET['post'];
	$data_emp = $db->query("SELECT * FROM brand WHERE id='$id'");
  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
                <div class="col-11 px-2 d-flex">
                  ...
                  <h5 class="d-flex justify-content-center align-items-center text-center"><?php if($action == 'update'){echo "Update";}else{echo "Add";} ?> Brand</h5> </div>
                  
                  <div class="col-1 px-2 d-flex">
                  <a href="brand_list.php" class="mr-2 d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 40px; height: 40px; text-align: center;"> <i class="fa fa-arrow-left" style="font-size: 25px; color:#fff;"></i> </a>
                   </div>
        ...
        <form role="form" method="post" enctype="multipart/form-data" action="brand_action.php">
                      ...
                      <table class="mytabledesing" width="100%">
                        ...
                        <tbody id="Tbodyvariation">
                          <tr id="TRbodyvariation">
                              ...
                              <td>
                              <input type="text" name="brand_name[]" value="<?php echo $value_emp->brand_name; ?>" class="form-control" placeholder="Brand Name"> </td>
