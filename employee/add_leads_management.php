        ...
        <form role="form" method="post" enctype="multipart/form-data" action="leads_action.php">
          ...
          <div class="col-lg-3 col-sm-6 col-12">
             ...
             <div class="col-lg-3 col-sm-6 col-12">
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								<label>Eastimate Amount</label>
								<input type="text" name="eastimate_amount" value="<?php echo $value_emp->eastimate_amount; ?>" class="form-control" placeholder="Eastimate Amount"> </div>
						</div>

							<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								<label>Mobile Name Or Model Number</label>
								<input type="text" name="mobile_or_model" value="<?php echo $value_emp->imei_number; ?>" class="form-control" placeholder="Mobile Name Or Model Number"> </div>
						</div>
						...
						<div class="col-lg-3 col-sm-6 col-12">
						 ...
						 <div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="text" name="mobile_number" value="<?php echo $value_emp->mobile_number; ?>" class="form-control" minlength="10" maxlength="10" oninput="validateNumberInput(this)" placeholder="Mobile Number" onchange="copyInputValueCustomer(this.value)" required> </div>
						</div>
            <div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
...
function copyInputValueCustomer(value) {
    $.ajax({
		type: "POST",
		url: 'get_customer_already.php',
		data: {
			value: value
		},
		success: function(data) {
			if(data.trim()=="yes"){
              ...
              // Check the result
              if (result) {
              document.getElementById('whatsapp_number2').value = value;
              } 
			}
		}
	});
