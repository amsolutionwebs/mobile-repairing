                          ...
                          <div class="row">
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" name="cat_id" onchange="getSubCat(this.value)" id="cat_id" required>
                      ...
                      <?php } ?>
                             ...
                             <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" name="model_number_id" id="model_number_id_get" <?php if($action=='update'){echo "";}else{echo "onchange='productTitleCreate(this.value)'";} ?>  required>
...
<script>
    function productTitleCreate(value){
    var cat_id  = $("#cat_id").val();
    var sub_cat_id  = $("#sub_cat_id").val();
    var model_number_id_get  = $("#model_number_id_get").val();
    ...
    data: {
      ...
      model_number_id_get : model_number_id_get,
      brand_id : brand_id
    },
    success: function(data) {
      $("#products_title").val(data);
    }
  });
