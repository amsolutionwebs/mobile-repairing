  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
                <div class="col-11 px-2 d-flex">
                  ...
                  <h5 class="d-flex justify-content-center align-items-center text-center">Add P.O.R Repair Product</h5> </div>
        ...
        <form role="form" method="post" enctype="multipart/form-data" action="por_repair_management_add_product_action.php">
          
          <div class="row px-2 py-3">
            
            <!-- registration page -->
            <div class="col-md-12">
              <h4 style="color:#d9534f;"><b>P.O.R Repair Product Details:-</b></h4>
              <hr> </div>
...
<td width="20">
<input type="text" name="quantity_invoice[]" class="quantity_invoice form-control text-center" id="quantity_invoice_update" placeholder="Quantity" onchange="Calc(this)" value="<?php echo $value_repair_details->qunatity; ?>" disabled required> </td>
...
<button type="button" class="btn setclose" style="background: #ea5455;" onclick="TableDelete(this,<?php echo $por_repair_id; ?>,<?php echo $value_repair_details->id; ?>)" disabled> <i class="fas fa-times text-light"></i> </button>
