...
$get_data = "SELECT * FROM variation_product_images WHERE id='$id'";
  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
                <div class="col-11 px-2 d-flex">
                  ...
                  <a href="variation_product_images_list.php?product_id=<?php echo $product_id; ?>&variation_id=<?php echo $variation_id; ?>&action=view" class="mr-2 d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 40px; height: 40px; text-align: center;"> <i class="fa fa-arrow-left" style="font-size: 25px; color:#fff;"></i> </a>
                   </div>
        ...
        <form role="form" method="post" enctype="multipart/form-data" action="variation_product_images_action.php">
