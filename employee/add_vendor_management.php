              ...
              <hr> </div>
				...
				<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="text" name="vendor_name" value="<?php echo $value_emp->vendor_name; ?>" class="form-control" placeholder="Vendor Name"> </div>
						</div>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="email" name="email_id" value="<?php echo $value_emp->email_id; ?>" class="form-control" placeholder="vendormail@mail.com"> </div>
						</div>
							...
							<div class="form-group">
								<label>Country</label>
								<select class="form-control select2" name="country" onchange="getState(this.value)" required>
									<option value="0">Select Country</option>
									 <?php 
                   $data_country = $db->query("SELECT * FROM `countries`");
                    while ($value_country = $data_country->fetch_object()) { ?>
                      
                      <option value="<?php echo $value_country->id; ?>"  <?php if($value_emp->country===$value_country->id){echo 'selected';} ?> style="text-transform: uppercase;"><?php echo  $value_country->name; ?></option>
                      <?php } ?>
								</select>
								</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								<label>State</label>
								<select class="form-control select2" name="state" id="state_field" required>
                      ...
                      <?php } ?>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="text" name="opening_blance" value="<?php echo $value_emp->opening_blance; ?>" class="form-control" placeholder="Opening Balance" oninput="validateNumberInput(this)"> </div>
						</div>
