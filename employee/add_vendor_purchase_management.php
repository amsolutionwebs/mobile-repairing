						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
								<div class="col-11 px-2 d-flex">
									...
									<h5 class="d-flex justify-content-center align-items-center text-center"><?php if($action=='update'){echo "Update";}else{echo "Add";} ?> Vendor Purchase Order</h5> </div>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="purchase_order_number" class="form-control purchase_order_number" value="<?php echo $freciept_name; ?>"  readonly> </div>
							</div>
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
