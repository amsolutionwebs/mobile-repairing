...
// delete vendor product details
if(isset($_POST['delete_vendor_purchase_order'])){
    $por_id = $_POST['por_id'];
    $product_details_id = $_POST['product_details_id'];
    $total_first = $_POST['total_first'];
    $miscs_name = $_POST['miscs_name'];
    $misc_value = $_POST['misc_value'];
    $round_off = $_POST['round_off'];
    $final_price = $_POST['final_price'];
    
    $query_update =  $db->query("UPDATE `purchase_order` SET `total_first`='$total_first',`misc_name`='$miscs_name',`misc_value`='$misc_value',`round_off`='$round_off',`final_price`='$final_price' WHERE id='$por_id'");


    if ($query_update) {
      $query_delete =  $db->query("DELETE FROM purchase_order_details WHERE id='$product_details_id'");
