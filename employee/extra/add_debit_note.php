						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
								<div class="col-11 px-2 d-flex">
									...
									<h5 class="d-flex justify-content-center align-items-center text-center"><?php if($action=='update'){echo "Update";}else{echo "Add";} ?> Debit Note</h5> </div>
							...
							<!--  -->
							<form role="form" method="post" enctype="multipart/form-data" action="debit_note_action.php" class="needs-validation" novalidate>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="debit_note_number" class="form-control invoice_number" value="<?php echo $invoice_number; ?>" <?php if($action!=='update'){ echo 'onchange="getDebitAlready(this.value)"';} ?> required>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="date" class="form-control cal-icon invoice_date"  value="<?php echo $invoice_date; ?>" name="debit_note_date" autocomplete="off" required> 
                    ...
                    while ($value_br = $data_bb->fetch_object()) { ?>
							...
							<div class="col-lg-3 col-sm-6 col-12 d-none" id="total_debit_amount">
								<div class="form-group">
									...
									<input type="text" class="form-control"  value="<?php echo $invoice_date; ?>" name="total_debit_amount" autocomplete="off"  required> </div>
							</div>
                    ...
                    $value_sort = $datasrt->fetch_object();
                    	...
                    	?>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="total_2" class="currency form-control text-center total_2" placeholder="Total" id="total_2" value="<?php echo $total_first;?>" > </td>
										</tr>
										<tr>
									...
									<thead style="background: #1b2850;">
										<tr>
											...
											<th><input type="number" name="units" class="units text-center" placeholder="Total Quantity" id="units" style="border: none;background: #1b2850;color: #fff;" value="<?php echo $units;?>" ></th>
											<th colspan="3" style="text-align: right !important;"><input type="number" name="total3" style="border: none;background: #1b2850;color: #fff;" class="total3 text-center" placeholder="All Total Amount" value="<?php echo $all_total_amount;?>" id="total3" ></th>
										</tr>
									</thead>
										</table>
									</div>
