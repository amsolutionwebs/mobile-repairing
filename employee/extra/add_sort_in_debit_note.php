	...
	<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<!--  -->
							<form role="form" method="post" enctype="multipart/form-data" action="debit_note_sort_add_action.php" class="needs-validation" novalidate>
		...
		<?php 
		 $dbn_id2 = $_GET['post'];
                   ...
                   $data_srt = $db->query("SELECT * FROM `debit_note_sort_data` WHERE `debit_note_id`='$dbn_id2'");
