          ...
          <div class="col-md-12">
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <!--  -->
                ...
                <form role="form" method="post" enctype="multipart/form-data" action="invoice_register_report_by_mill.php">
                 <div class="row px-2 py-3">
            
            <!-- registration page -->
            <div class="col-md-12">
              <h4 style="color:#d9534f;"><b>Choose Mill Details For invoice Register:-</b></h4>
              <hr> </div>
