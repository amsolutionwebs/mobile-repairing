						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
								<div class="col-11 px-2 d-flex">
									...
									<h5 class="d-flex justify-content-center align-items-center text-center">Select Mill And Dealer Detail For Indent Print</h5> </div>
							...
							<!--  -->
							<form role="form" method="get" enctype="multipart/form-data" action="print_indent_final_docs.php">
								<div class="row px-2 py-3">
									<!-- registration page -->
									<div class="col-md-12">
										<h4 style="color:#d9534f;"><b>Mill And Dealer Details for Indent Print:-</b></h4>
										<hr> </div>
                   ...
                   $data_dealer = $db->query("SELECT * FROM `dealer` WHERE status='enable' AND company_id='$company_login_id'");
                    while ($value_dealer = $data_dealer->fetch_object()) { ?>
							...
							<div class="col-lg-4 col-sm-4 col-12">
								...
								<select class="form-control py-2 indent_by_default_mill" id="indent_by_default_mill" name="indent_no">
																	<option value="0">--Choose Indent Number--</option>
...
function getInvoiceForIntimation(value){
		...
		success: function(data) {
			...
			$("#indent_by_default_mill").html(data);
		}
	});
}  
