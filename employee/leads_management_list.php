              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <span>  <?php 
$data4 = $db->query("SELECT count(id) as total_fees FROM leads_managment WHERE store_id='$store_id'");
...
?></span>
                ...
                <tr>
                 ...
                 <?php
                    ...
                    $data = $db->query("SELECT * FROM leads_managment WHERE store_id='$store_id' ORDER BY id DESC");
...
<?php } ?>
      ...
      <?php if ($view_leads=='yes') { ?>
            <a href='view_leads_managment.php?post=<?php echo $value->id; ?>&action=update' title='View'><button class='btn btn-xs btn-success mr-2 p-1'><i class='fas fa-eye'></i> </button></a>
