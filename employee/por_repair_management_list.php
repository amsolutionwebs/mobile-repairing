              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <?php }else{ ?>
                    ...
                    <div class="d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 50px; height: 50px; text-align: center;">
                      <i class="fa fa-gears" style="font-size: 30px; color:#fff;"></i>
                    </div>
                  ...
                  <div class="col-10">
                    ...
                    <span> <?php $data_total = $db->query("SELECT count(id) as por_repair_total FROM por_repair_managment WHERE store_id='$store_id'");
                    $por_repair_total = $data_total->fetch_object(); 

                    echo $por_repair_total->por_repair_total
                ...
                <tr>
                 ...
                 <?php
                    ...
                    $data = $db->query("SELECT * FROM por_repair_managment WHERE store_id='$store_id'");
                    ...
                    $pamount = (float)($value_purchase->purchase_amount)+(float)$value->total_amount;
                                          ?>
                <tr>
                  ...
                  <td><i class="fa fa-inr"></i><?php echo number_format((float)$value_purchase->purchase_amount,2); ?></td>
                  <td><i class="fa fa-inr"></i><?php echo number_format((float)$value->total_amount,2); ?></td>
                  <td><i class="fa fa-inr"></i><?php echo number_format($pamount,2); ?></td>
                  
                  <td><?php echo $value->status; ?></td>
                  
                  
                  <td>
                     <?php if ($view_por_repair=='yes') { ?>
