              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <span>  <?php 
$data4 = $db->query("SELECT count(id) as total_fees FROM purchase_managment WHERE store_id='$store_id' AND status='enable'");
...
?></span>
    ...
    <?php } if ($delete_purchase_old=='yes') { ?>
