...
?></span>
                ...
                <tr>
                 ...
                 <?php
                    ...
                    $data13 = $db->query("SELECT * FROM `sub_variation_type` WHERE id='$value->sub_variation_type_id'");
                    $value13 = $data13->fetch_object();
                ...
                <tr>
                  ...
                  <td><?php echo $value13->sub_variation_type; ?></td>
