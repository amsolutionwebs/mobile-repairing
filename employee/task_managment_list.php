                ...
                <div class="row">
                  <div class="col-1">
                    ...
                    <div class="d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 50px; height: 50px; text-align: center;">
                      <a href="#"><i class="fa fa-bar-chart" style="font-size: 30px; color:#fff;"></i></a>
                    </div>
                  <?php }else{ ?>
                  ...
                  <div class="col-10">
                    ...
                    <span>  <?php 
$data4 = $db->query("SELECT count(id) as total_fees FROM eng_task WHERE store_id='$store_id' AND user_id='$user_id'");
