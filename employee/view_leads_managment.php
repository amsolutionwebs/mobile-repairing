             ...
             <div class="col-lg-3 col-sm-6 col-12">
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="datetime-local" name="leads_date" value="<?php echo $value_emp->leads_date; ?>" class="form-control" readonly> </div>
						</div>
						
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								<label>Leads Type</label>
								<select class="form-control select2" name="leads_type" disabled>
				...
				<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="text" name="imei_number" value="<?php echo $value_emp->imei_number; ?>" class="form-control" placeholder="013226002448955" readonly> </div>
						</div>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="text" name="product_password" value="<?php echo $value_emp->product_password; ?>" class="form-control" placeholder="****************" readonly> </div>
						</div>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="date" name="followup_date" value="<?php echo $value_emp->followup_date; ?>" class="form-control" readonly> </div>
						</div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
								...
								<input type="text" name="remark1" value="<?php echo $value_emp->remark1; ?>"  class="form-control" placeholder="Customer Remark" readonly> </div>
                                </div>
                                
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
								<label>Remark 2</label>
								<input type="text" name="remark2" value="<?php echo $value_emp->remark2; ?>"  class="form-control" placeholder="Remark 2" readonly> </div>
                                </div>
                            </div>
                        </div>
