						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control cal-icon purchase_order_date" placeholder="Choose Purchase Date" value="<?php echo $value_emp->purchase_order_date; ?>" name="purchase_order_date" disabled> </div>
							</div>
							
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									<label>Vendor Name</label>
									<select class="form-control select2 vendor_id" name="vendor_id" disabled>
                   ...
                   $data1 = $db->query("SELECT * FROM `products`");
                    while ($value_products = $data1->fetch_object()) { ?>
                      ...
                      <?php } ?>
													...
													<td>
														<input type="text" name="product_desc[]" class="product_desc form-control text-center" id="product_desc" placeholder="Description" value="<?php echo $value_order_details->product_desc; ?>" disabled required> </td>
													<td>
														<input type="text" name="quantity[]" class="quantity form-control text-center" id="quantity" placeholder="Quantity"  value="<?php echo $value_order_details->quantity; ?>" disabled onchange="Calc(this)" required> </td>
												<td>
											<input type="text" name="price[]" class="price form-control text-center" id="price" placeholder="Price" onchange="Calc(this)" value="<?php echo $value_order_details->price; ?>" disabled required> </td>
											<td>
												<input type="text" name="total[]" class="total_amount_first form-control text-center" placeholder="Total" id="total_amount_first" value="<?php echo $value_order_details->total; ?>" disabled required readonly> </td>
...
<?php } ?>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="total_first" class="currency form-control text-center total_first" placeholder="Total" id="total_first" value="<?php echo $value_emp->total_first;?>" disabled> </td>
										</tr>
										...
										<tr>
											...
											<td colspan="3" style="text-align: center;"> <input type="text" name="miscs_name" class="miscs_name form-control text-center" placeholder="Misc. Name"  value="<?php echo $value_emp->misc_name;?>" disabled></td>
											<td colspan="3">
												<input type="text" name="misc_value" class="misc_value form-control text-center" placeholder="Total Misc Value" id="misc_value" value="<?php echo $value_emp->misc_value;?>" onchange="getMiscOff(this.value)" disabled> </td>
										</tr>
									...
									<thead style="background: #1b2850;">
										<tr>
											...
											<th colspan="4" style="text-align: right !important;"><input type="text" name="final_price" style="border: none;background: #1b2850;color: #fff;font-size:18px;" class="final_price text-center" placeholder="All Total Amount" value="<?php echo $value_emp->final_price;?>" id="final_price" disabled></th>
										</tr>
									</thead>
										</table>
									</div>
