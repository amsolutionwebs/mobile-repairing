                ...
                <div class="row">
                  <div class="col-1">
                    <div class="d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 50px; height: 50px; text-align: center;">
                      <i class="fa fa-percent" style="font-size: 30px; color:#fff;"></i>
                    </div>
                  </div>
                  <div class="col-10">
                  
                    <h5> All Employee Commission</h5>
                    <span>  <?php 
...
?></span>
                ...
                <tr>
                  ...
                  <th>Action</th>
                    ...
                    $data1 = $db->query("SELECT * FROM employee_commission");
                ...
                <tr>
                  ...
                  <td><?php echo $value1->commission; ?></td>
                  ...
                  <td>
                           ...
                           <a href='employee_commission_action.php?post=<?php echo $value1->id; ?>&action=delete' title='Delete' onClick="return confirm('Are You Sure want to delete ?')" ><button class='btn btn-xs btn-danger p-1'><i class='fas fa-trash'></i> </button></a>
