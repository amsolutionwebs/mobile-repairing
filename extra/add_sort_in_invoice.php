						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
								<div class="col-11 px-2 d-flex">
									...
									<h5 class="d-flex justify-content-center align-items-center text-center">Entry Invoice</h5> </div>
							...
							<!--  -->
							<form role="form" method="post" enctype="multipart/form-data" action="invoice_sort_action.php">
...
<tr id="TRbodyinvoice">
													<td id="mysort" width="230">
																...
																<select class="form-control myselect2 sort_select" name="sort_no[]" id="sort_by_indent" required>
                   ...
                   $data_indent_plus = $db->query("SELECT * FROM `indent_plus` WHERE indent_id='$indent_id'");
                    ...
                    $value_sort = $datasrt->fetch_object();
                    	...
                    	?>
											...
											<td>
												<input type="text" name="total_amount_first[]" class="total_amount_first form-control text-center" placeholder="Total" id="total_amount_first" value="<?php echo $value_entry->total_one;?>"  disabled> </td>
													<td class="text-center justify-conent-center">
				...
				if(response.trim() != "no_data"){
				   ...
				   $(tbd).find("#rate_invoice").val(all_data[0].price);
					  ...
					  var qty =	$(tbd).find("#quantity_invoice").val();
						...
						var amt = qty*rate;
						$(tbd).find("#total_amount_first").val(amt).toFixed(2);
						total1();
						}else{
		    	    alert("No Data Found");
		    	}
