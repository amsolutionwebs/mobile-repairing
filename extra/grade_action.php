...
case 'publish':
 ...
 $query = $db->query("SELECT * FROM grade WHERE grade='$grade' AND company_id='$company_id'");
  if($query->num_rows > 0){
 ...
 $db->query("INSERT INTO `grade`(`company_id`, `grade`, `description`,`date`) VALUES ('$company_id','$grade','$description','$post_date_time')");
