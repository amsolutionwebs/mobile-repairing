...
?></span>
  ...
  <tbody>
                 <?php
                    ...
                    $data = $db->query("SELECT * FROM invoice WHERE company_id='$company_login_id' AND `default_mill_code`='$default_mill_id'");
                ...
                <tr>
                  ...
                  <td><?php echo $value->total_first; ?></td>
                  <td><?php 
                   ...
                   $data_master = $db->query("SELECT * FROM `mill` WHERE company_id='$company_login_id' AND id='$default_mill_id'");
                    ...
                    $value_subm = $datasubm->fetch_object();
                     ...
                     echo $value_subm->commission;
                      ...
                      ?>/100*<?php echo $value->total_first; ?></td>
          ...
          <thead>
              <tr>
                ...
                <th >
                 <?php 
$data_ex = $db->query("SELECT sum(total_first) as total_ex FROM `invoice` WHERE company_id='$company_login_id' AND `default_mill_code`='$default_mill_id'");
$total_exe = $data_ex->fetch_object();
echo $total_exe->total_ex;
...
$total_exe = $data_ex->fetch_object();
                   ...
                   $data_master = $db->query("SELECT * FROM `mill` WHERE company_id='$company_login_id' AND id='$default_mill_id'");
                    $value_master = $data_master->fetch_object();
                    $commission1 = $value_master->commission;
                    ...
                    $value_subm = $datasubm->fetch_object();
                     ...
                     $commission =  $value_subm->commission;
