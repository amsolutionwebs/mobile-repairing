            ...
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
                <div class="col-11 px-2 d-flex">
                  ...
                  <h5 class="d-flex justify-content-center align-items-center text-center"> Mill Details For Turnover</h5> </div>
              ...
              <!--  -->
                ...
                <form role="form" method="post" enctype="multipart/form-data" action="turnover_report_by_mill.php">
                 <div class="row px-2 py-3">
            
            <!-- registration page -->
            <div class="col-md-12">
              <h4 style="color:#d9534f;"><b>Choose Mill Details For Turnover :-</b></h4>
              <hr> </div>
