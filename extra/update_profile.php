...
<form class="update_profile" method="post" enctype="multipart/form-data" action="profile_action.php">
    ...
    if($valuepic){ ?>
<img src="<?php echo ROOTPIMG;?>/<?php echo $valuepic->profile_picture; ?>" id="output1" style="width: 100%; border:7px solid #fff;border-radius: 50%;width: 200px;height: 200px;" />
<?php
    }else{ ?><img src="dist/img/No-Image-Basic.png" id="output1" style="width: 100%; border:7px solid #fff;border-radius: 50%;" />
<?php
    }?>
