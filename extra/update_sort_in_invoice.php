						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<form role="form" method="post" enctype="multipart/form-data" action="invoice_sort_update_action.php">
								<div class="row px-2 py-3">
									<!-- registration page -->
									<div class="col-md-12">
										<h4 style="color:#d9534f;"><b>Update Inovice Entry Details:-</b></h4>
										<hr> </div>
...
<?php } ?>
										...
										<tr>
											...
											<td colspan="1" style="text-align: center;"> <input type="number" name="insurance" class="insurance form-control text-center" value="<?php echo $insurance;?>" placeholder="Insurance (With Value)" id="insurance" onchange="Calc2(this)" required></td>
											<td colspan="3">
