...
if(isset($_GET['post']))
{
	...
	$data_cmp = $db->query("SELECT * FROM credit_note WHERE id='$id'");
	...
	$credit_note_number = $master_value->credit_note_number;
	$credit_note_date = $master_value->credit_note_date;
	...
	$total_credit_note_amount = $master_value->total_credit_note_amount;
						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
								<div class="col-11 px-2 d-flex">
									...
									<h5 class="d-flex justify-content-center align-items-center text-center"> Credit Note Details</h5> </div>
							...
							<!--  -->
							<form role="form" method="post" enctype="multipart/form-data" action="credit_note_update_action.php" class="needs-validation" novalidate>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="credit_note_number" class="form-control invoice_number" value="<?php echo $credit_note_number; ?>" <?php if($action!=='update'){ echo 'onchange="getDebitAlready(this.value)"';} ?> disabled>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="date" class="form-control cal-icon invoice_date"  value="<?php echo $credit_note_date; ?>" name="credit_note_date" autocomplete="off" disabled> 
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<select class="form-control select2 document_through" name="refrence" onchange="getReferenceValue(this.value)" disabled>
                   ...
                   $data_bb = $db->query("SELECT * FROM `broker` WHERE company_id='$company_login_id'");
                    while ($value_br = $data_bb->fetch_object()) { ?>
								...
								<div class="form-group">
									...
									<select class="form-control indent_no" name="invoice_number" id="indent_no_invoice" onchange="getInvoiceValueData(this.value)" disabled>
                    ...
                    while ($value_inv = $data_inv->fetch_object()) { ?>
							...
							<div class="col-lg-3 col-sm-6 col-12 <?php if($refrence==='Goods_Return'){echo "d-none";}else{ echo "d-block";}?>" id="total_debit_amount">
								<div class="form-group">
									...
									<input type="text" class="form-control"  value="<?php echo $total_credit_note_amount; ?>" name="total_credit_note_amount" autocomplete="off"  disabled> </div>
							</div>
							...
							<div class="col-lg-3 col-sm-6 col-12 <?php if($refrence==='Goods_Return'){echo "d-block";}else{ echo "d-none";}?>" id="doc_encl_fields">
								<div class="form-group">
									...
									<select class="form-control doc_encl" name="doc_encl" disabled>
							...
							<div class="col-lg-3 col-sm-6 col-12 <?php if($refrence==='Goods_Return'){echo "d-block";}else{ echo "d-none";}?>" id="lr_no_fields">
								<div class="form-group">
									...
									<input type="text" value="<?php echo $lr_no; ?>" name="lr_no" class="form-control lr_no" id="lr_no" disabled> </div>
							</div>
							<div class="col-lg-3 col-sm-6 col-12 <?php if($refrence==='Goods_Return'){echo "d-block";}else{ echo "d-none";}?>" id="lr_date_fields">
								<div class="form-group">
									<label>LR Date </label>
									<input type="date" class="form-control cal-icon lr_date" placeholder="Choose Lr Date" name="lr_date" value="<?php echo $lr_date; ?>" autocomplete="off" id="lr_date" disabled> </div>
							</div>
							
							<div class="col-lg-12 col-sm-12 col-12">
								<div class="form-group">
									<label>Remark</label>
									<textarea rows="2" class="form-control" name="remark" disabled><?php echo $remark; ?></textarea> </div>
							</div>
									...
									?>
												...
												<tr id="TRbodyinvoice">
													<td id="mysort" width="230">
																...
																<select class="form-control myselect2 sort_select" name="sort_no[]" id="sort_by_indent" disabled>
											...
											<td>
												...
												<input type="hidden" name="sort_post_id[]" value="<?php echo $value_entry->id;?>">
													...
													<td class="text-center justify-conent-center">
														<button type="button" class="btn btn-filter setclose" style="background: #ea5455;" onclick="TableDelete(this,<?php echo $value_entry->id;?>)" disabled> <i class="fas fa-times text-light"></i> </button>
													</td>
												</tr>
...
<?php } ?>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="total_2" class="form-control text-center total_2" placeholder="Total" id="total_2" value="<?php echo $total_first;?>" disabled> </td>
										</tr>
										...
										<tr>
											...
											<td colspan="1" style="text-align: center;"> 
												...
												<input type="text" name="cashd" class="cashd form-control text-center cashd" placeholder="Cash.D (in %)" value="<?php echo $cashdiscount;?>" id="cashd" disabled >
											</td>
											<td colspan="3">
												<input type="text" name="total_cashd" class="total_cashd form-control text-center cashd" placeholder="Total Value Of Cash Discount" id="total_cashd" value="<?php echo $total_cashdiscount; ?>" disabled> </td>
										</tr>

										<tr>
											<td colspan="3" style="text-align: center;"> Insurance (Value)</td>
											<td colspan="1" style="text-align: center;"> <input type="text" name="insurance" class="insurance form-control text-center" value="<?php echo $insurance;?>" placeholder="Insurance (With Value)" id="insurance" disabled ></td>
											<td colspan="3">
										...
										<tr>
											...
											<td colspan="1" style="text-align: center;"> 
											<input type="text" name="cgst" class="cgst form-control text-center" value="<?php echo $cgst;?>" placeholder="CGST (in %)" id="cgst" onchange="Calc2(this)" disabled></td>
											<td colspan="3">
												<input type="text" name="total_cgst" class="total_cgst form-control text-center" placeholder="Total Value Of CGST" id="total_cgst" value="<?php echo $total_cgst;?>" disabled> </td>
										</tr>
										
										<tr>
											<td colspan="3" style="text-align: center;"> SGST (%)</td>
											<td colspan="1" style="text-align: center;"> 
											<input type="text" name="sgst" class="sgst form-control text-center" value="<?php echo $sgst;?>" placeholder="SGST (in %)" id="sgst" onchange="Calc2(this)" disabled>
										</td>
											<td colspan="3">
												<input type="text" name="total_sgst" class="total_sgst form-control text-center" placeholder="Total Value Of SGST" id="total_sgst" value="<?php echo $total_sgst;?>" disabled> </td>
										</tr>
										<tr>
											<td colspan="3" style="text-align: center;"> IGST (%)</td>
											<td colspan="1" style="text-align: center;"> <input type="text" name="igst" class="igst form-control text-center" placeholder="IGST (in %)" value="<?php echo $igst;?>" id="igst" onchange="Calc2(this)" disabled></td>
											<td colspan="3">
												<input type="text" name="total_igst" class="total_igst form-control text-center" placeholder="Total Value Of IGST" id="total_igst" value="<?php echo $total_igst; ?>" disabled> </td>
										</tr>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="total_miscs" class="total_miscs form-control text-center" placeholder="Total Misc Value" id="total_miscs" value="<?php echo $misc_value;?>" onchange="getMiscOff(this.value)" disabled> </td>
										</tr>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="round_off" class="round_off form-control text-center" placeholder="Round Off" id="round_off" onchange="getRoundOff(this)" value="<?php echo $round_off; ?>" disabled> </td>
										</tr>
									</tbody>
									<thead style="background: #1b2850;">
										<tr>
											<th colspan="3">Total Amount </th>
											<th><input type="text" name="units" class="units text-center" placeholder="Total Quantity" id="units" style="border: none;background: #1b2850;color: #fff;" value="<?php echo $units;?>" disabled></th>
											<th colspan="3" style="text-align: right !important;"><input type="text" name="total3" style="border: none;background: #1b2850;color: #fff;" class="total3 text-center" placeholder="All Total Amount" value="<?php echo $all_total_amount;?>" id="total3" disabled></th>
										</tr>
									</thead>
										</table>
									</div>
