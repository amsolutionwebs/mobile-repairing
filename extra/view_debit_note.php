						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
								<div class="col-11 px-2 d-flex">
									...
									<h5 class="d-flex justify-content-center align-items-center text-center">View Debit Note</h5> </div>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="debit_note_number" class="form-control invoice_number" value="<?php echo $debit_note_number; ?>" <?php if($action!=='update'){ echo 'onchange="getDebitAlready(this.value)"';} ?> disabled>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="date" class="form-control cal-icon invoice_date"  value="<?php echo $debit_note_date; ?>" name="debit_note_date" autocomplete="off" disabled> 
							...
							<div class="col-lg-3 col-sm-6 col-12">
								...
								<div class="form-group">
									...
									<select class="form-control default_mill_code" name="default_mill_code" disabled>
                    ...
                    while ($value_inv = $data_inv->fetch_object()) { ?>
							...
							<div class="col-lg-3 col-sm-6 col-12 <?php if($refrence==='Goods_Return'){echo "d-none";}else{ echo "d-block";}?>" id="total_debit_amount">
								<div class="form-group">
									...
									<input type="text" class="form-control"  value="<?php echo $total_debit_amount; ?>" name="total_debit_amount" autocomplete="off" disabled > </div>
							</div>
        ...
        $value_sort = $data3->fetch_object();
                    	...
                    	?>
											...
											<td>
												...
												<input type="hidden" name="sort_post_id[]" value="<?php echo $value_entry->id;?>" disabled>
												 </td>
...
<?php } ?>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="total_2" class="currency form-control text-center total_2" placeholder="Total" id="total_2" value="<?php echo $total_first;?>" disabled> </td>
										</tr>
										...
										<tr>
											...
											<td colspan="1" style="text-align: center;"> 
												...
												<input type="text" name="cashd" class="cashd form-control text-center cashd" placeholder="Cash.D (in %)" value="<?php echo $cashdiscount;?>" id="cashd" onchange="Calc2(this)" disabled>
											</td>
											<td colspan="3">
										...
										<tr>
											...
											<td colspan="1" style="text-align: center;"> <input type="text" name="insurance" class="insurance form-control text-center" value="<?php echo $insurance;?>" placeholder="Insurance (With Value)" id="insurance" onchange="Calc2(this)" disabled></td>
											<td colspan="3">
												<input type="text" name="total_insurance" class="total_insurance form-control text-center" placeholder="Total Value Of Insurance" value="<?php echo $total_insurance;?>" id="total_insurance" disabled> </td>
										</tr>
										<tr>
