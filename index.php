...
?>
	...
	<head>
		...
		<title>Welcome Back MWB | Login</title>
...
<link rel="manifest" href="dist/fevicon/site.webmanifest">
    ...
    text-shadow: 3px 2px black;"><i class="fa fa-gear fa-spin"></i> ADMIN PANEL</h1> </div>
							<div class="login-panel panel panel-default text-center"> <img src="dist/img/enquiry.png" class="img-responsive center-block rounded-circle mb-4" alt="Logo" width="100px" style="border-radius: 50%;border:1px solid #ccc;" />
								<div class="panel-body text-center">
									<form class="form-signin" method="post" action="loginaction.php" enctype="multipart/form-data" onsubmit="return validateForm()" name="myForm">
										<fieldset>
											<div class="form-group">
												<select class="form-control" name="usertype" title="Please Choose Type" required="" autofocus>
													<option value="">Choose User Type</option>
													<option value="suparadmin">Supar Admin</option>
