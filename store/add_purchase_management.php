             ...
             <div class="col-lg-3 col-sm-6 col-12">
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="datetime-local" name="purchase_date" value="<?php echo $value_emp->purchase_date; ?>" class="form-control" required> </div>
						</div>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="text" name="purchase_amount" value="<?php echo $value_emp->purchase_amount; ?>" class="form-control" oninput="validateNumberInput(this)" placeholder="Purchase Amount" required> </div>
						</div>
						  ...
						  <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" name="cat_id" onchange="getSubCat(this.value)" id="getCategoryData" required>
           ...
           <?php 
                    ...
                    while ($value14 = $data14->fetch_object()) { ?>
                      ...
                      <?php } ?>
							...
							<div class="form-group">
								...
								<select class="form-control select2" name="problem_diagnosis" onchange="getProblemField(this.value)" required>
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" name="products_title" id="products_title" value="<?php echo $value_emp->products_title; ?>" placeholder="Products Title" required> </div>
                            </div>

                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="products_qty">SKU Number. :</label>
                                <input type="text" name="products_sku" class="form-control" value="<?php echo $value_emp->products_sku; ?>" placeholder="SKU Number"> </div>
                            </div>
						...
						<div class="col-lg-12 col-sm-6 col-12">
							<div class="form-group">
								...
								<textarea class="form-control" name="address" required> <?php echo $value_emp->customer_address; ?></textarea>
           	...
           	<div class="col-lg-12 col-sm-6 col-12">
							<div class="form-group">
								...
								<textarea class="form-control" name="remark"> <?php echo $customer_remark; ?></textarea>
