        ...
        <form role="form" method="post" enctype="multipart/form-data" action="repair_management_action.php">
          ...
          <div class="row px-2 py-3">
           ...
           <div class="form-group">
                       ...
                       <input type="text" id="product_url" value="" placeholder="Enter scan code" class="form-control" autofocus renat="server">
                      </div>
             </div>
           ...
           <div class="form-group">
                       ...
                       <button class="btn btn-success" onclick="window.location.href='bwstw://startscanner?field=product_url'" type="button">Scan Me</button>
                      </div>
             </div>
                  ...
                  <div class="row px-2 py-3">
                    <div class="col-lg-12 col-sm-12 col-12">
                      <div class="form-group">
                       ...
                       <input type="text" name="product_id" value="" placeholder="Enter scan code" class="form-control">
                      </div>
                    </div>
...
function afterScanFunction() {
		var inputBc = 	document.getElementById("product_url");
		alert("SCANNER RESULT:"+ inputBc.value);
