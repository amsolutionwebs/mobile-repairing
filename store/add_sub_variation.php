            ...
            <div class="card mt-2 px-1" style="border-top:3px solid tomato;">
              ...
              <div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
                <div class="col-11 px-2 d-flex">
                  ...
                  <h5 class="d-flex justify-content-center align-items-center text-center"><?php if($action == 'update'){echo "Update";}else{echo "Add";} ?> Sub Variation</h5> </div>
                   ...
                   $data1 = $db->query("SELECT * FROM `variation`");
                    while ($value1 = $data1->fetch_object()) { ?>
                      ...
                      <?php } ?>
                            ...
                            <td>
                              <input type="text" name="sub_variation_name[]" value="<?php echo $value_emp->sub_variation_name; ?>" class="form-control" placeholder="Sub Variation Name"> </td>
