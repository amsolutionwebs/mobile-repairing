...
$datey = date("Y");
$date_next = date("y")+1;
$data = $db->query("SELECT * FROM indent WHERE company_id='$company_login_id' ORDER BY id DESC LIMIT 1");
$value = $data->fetch_object();
$recipt_name = $value->indent_no;
				...
				<div class="row">
                   ...
                   $data_master = $db->query("SELECT * FROM `mill` WHERE company_id='$company_login_id'");
                    while ($value_master = $data_master->fetch_object()) { ?>
									...
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											<label>Master Mill Name</label>
											<input type="text" name="mill_name"  id="mill_name_2" class="form-control mill_name_indent" readonly="readonly"> </div>
									</div>
                   ...
                   $datasubm = $db->query("SELECT * FROM `submill` WHERE status='enable' AND company_id='$company_login_id'");
                    while ($value_subm = $datasubm->fetch_object()) { ?>
									...
									<div class="col-lg-3 col-sm-6 col-12 <?php if(empty($sub_mill_code)){echo " d-none ";}else{echo "ddd ";} ?>" id="submillfieldname_2">
										<div class="form-group">
											<label>Mill Name</label>
											<input type="text" name="sub_mill_name" id="sub_mill_name_2" class="form-control sub_mill_name_indent" readonly="readonly"> </div>
									</div>
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											<label>Indent No</label>
											<input type="text" class="form-control indent_no" name="indent_no" value="<?php echo $freciept_name; ?>" readonly> </div>
									</div>
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											<label>Indent Date</label>
											<input type="date" class="form-control datetimepicker cal-icon indent_date" placeholder="Choose Date" name="indent_date" autocomplete="off" > </div>
									</div>
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											<label>Dealer Code</label>
											<select class="form-control dealer_code" name="dealer_code" onchange="getDealerName_2(this.value)">
                   ...
                   $data_dealer = $db->query("SELECT * FROM `dealer` WHERE status='enable' AND company_id='$company_login_id'");
                    while ($value_dealer = $data_dealer->fetch_object()) { ?>
													<option value="<?php echo $value_dealer->id; ?>">
									...
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											...
											<select class="form-control document_through" name="document_through">
												...
												<option value="Direct To Buyer">Direct To Buyer</option>
												<option value="Direct to Us For Collection">Direct to Us For Collection</option>
											</select>
										</div>
									</div>
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											...
											<input type="text" name="destination" class="form-control destination" class="form-control" required> </div>
									</div>
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											<label>Transporter </label>
											<input type="text" name="transporter" class="form-control transporter" class="form-control" required> </div>
									</div>
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											<label>Broker/Salesman</label>
											<select class="form-control firt_broker" name="firt_broker">
												<option value="0">--Choose Broker/Salesman--</option>
												<?php 
                   ...
                   $data_broker = $db->query("SELECT * FROM `broker` WHERE status='enable' AND company_id='$company_login_id'");
                    while ($value_broker = $data_broker->fetch_object()) { ?>
													<option value="<?php echo $value_broker->id; ?>">
									...
									<div class="col-lg-3 col-sm-6 col-12">
										<div class="form-group">
											...
											<input type="text" name="currency" class="currency form-control"> </div>
									</div>
									<div class="col-lg-12 col-sm-12 col-12">
										<div class="row">
											...
											<div class="col-lg-12 col-sm-12 col-12">
												<div class="form-group">
													<label>Remark </label>
													<textarea name="remark" class="remark form-control"></textarea>
												</div>
											</div>
										</div>
									</div>
													...
													<td id="mysort" width="320">
														<div class="row">
															<div class="col-lg-9 col-sm-9 col-9" id="sort_fileds">
																<select class="form-control py-2 sort_select" id="sort_by_master_mill" name="sort_no[]">
                   ...
                   $data_gradel = $db->query("SELECT * FROM `grade` WHERE company_id='$company_login_id' ORDER BY id DESC");
                    while ($value_gradel = $data_gradel->fetch_object()) { ?>
													...
													<td>
														<input type="number" class="form-control quantity" name="quantity" placeholder="Quantity"> </td>
													<td>
														<input type="number" class="form-control price" name="price" placeholder="Price"> </td>
