                    ...
                    while ($value_br = $data_bb->fetch_object()) { ?>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<select class="form-control select2 indent_no" name="indent_no" id="indent_no_invoice" onchange="getIndentValueInvoice(this.value)">
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<select class="form-control select2 document_through" name="document_through" required>
										...
										<option value="Direct To Buyer" <?php if($document_through=='Direct To Buyer' ){ echo "selected";}?>>Direct To Buyer</option>
										<option value="Direct to Us For Collection" <?php if($document_through=='Direct to Us For Collection' ){ echo "selected";}?>>Direct to Us For Collection</option>
									</select>
								</div>
							</div>
							<div class="col-lg-3 col-sm-6 col-12">
...
<tr id="TRbodyinvoice">
													<td id="mysort" width="230">
																...
																<select class="form-control myselect2 sort_select" name="sort_no[]" id="sort_data_by_indent" required>
                    ...
                    $value_sort = $datasrt->fetch_object();
                    	...
                    	?>
											...
											<?php } ?>
													...
													<td>
														<input type="text" name="hsn_code[]" class="hsn_code form-control text-center" id="hsn_code" placeholder="HSN/SAC Code" required>
													</td>
													<td>
                    ...
                    $value_sort = $datasrt->fetch_object();
                    	...
                    	?>
											...
											<?php } ?>
													...
													<td>
														<input type="text" name="hsn_code[]" class="hsn_code form-control text-center" id="hsn_code" placeholder="HSN/SAC Code" value="<?php echo $value_entry->hsn_code;?>" disabled>
													</td>
													<td>
											...
											<td>
												<input type="number" name="total_amount_first[]" class="total_amount_first form-control text-center" placeholder="Total" id="total_amount_first" value="<?php echo $value_entry->total_one;?>"  disabled> </td>
													<td class="text-center justify-conent-center">
														<button type="button" class="btn btn-filter setclose" style="background: #ea5455;" onclick="TableDelete(this)" disabled> <i class="fas fa-times text-light"></i> </button>
													</td>
												</tr>
...
<?php } ?>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="total_miscs" class="total_miscs form-control text-center" placeholder="Total Misc Value" id="total_miscs" value="" onchange="getMiscOff(this.value)"> </td>
										</tr>
									...
									<thead style="background: #1b2850;">
										<tr>
											...
											<th colspan="3" style="text-align: right !important;"><input type="text" name="total3" style="border: none;background: #1b2850;color: #fff;font-size:18px;" class="total3 text-center" placeholder="All Total Amount" value="<?php echo $all_total_amount;?>" id="total3"></th>
										</tr>
									</thead>
										</table>
									</div>
...
function Calc2(value) {
	...
	document.getElementById("total_cgst").value = cgst_value_percentage;
	var sgst_value_percentage = (cash_discounted_value) * (sgst) / 100;
	document.getElementById("total_sgst").value = sgst_value_percentage;
	var igst_value_percentage = (cash_discounted_value * igst) / 100;
	document.getElementById("total_igst").value = igst_value_percentage;
