						...
						<div class="card mt-2 px-1" style="border-top:3px solid tomato;">
							...
							<div class="row py-2 px-1 border-bottom" style="background: #e0f7e870;">
								<div class="col-11 px-2 d-flex">
									...
									<h5 class="d-flex justify-content-center align-items-center text-center">Update Credit Note</h5> </div>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="credit_note_number" class="form-control invoice_number" value="<?php echo $credit_note_number; ?>" <?php if($action!=='update'){ echo 'onchange="getDebitAlready(this.value)"';} ?> required>
							...
							<div class="col-lg-3 col-sm-6 col-12">
								<div class="form-group">
									...
									<input type="date" class="form-control cal-icon invoice_date"  value="<?php echo $credit_note_date; ?>" name="credit_note_date" autocomplete="off" required> 
                    ...
                    while ($value_inv = $data_inv->fetch_object()) { ?>
							...
							<div class="col-lg-3 col-sm-6 col-12 <?php if($refrence==='Goods_Return'){echo "d-none";}else{ echo "d-block";}?>" id="total_debit_amount">
								<div class="form-group">
									...
									<input type="text" class="form-control"  value="<?php echo $total_credit_note_amount; ?>" name="total_credit_note_amount" autocomplete="off"  > </div>
							</div>
        ...
        $value_sort = $data3->fetch_object();
                    	...
                    	?>
											...
											<?php } ?>
													...
													<td>
														<input type="text" name="hsn_code[]" class="hsn_code form-control text-center" id="currency_invoice" placeholder="HSN/SAC Code" value="<?php echo $value_entry->hsn_code;?>" >
													</td>
													<td>
														<input type="text" name="unit_messure[]" class="unit_messure form-control text-center" id="unit_messure" value="<?php echo $value_entry->units;?>" placeholder="U/M" > </td>
													<td>
														<input type="text" name="quantity_invoice[]" class="quantity_invoice form-control text-center" id="quantity_invoice" placeholder="Quantity" onchange="Calc(this)" value="<?php echo $value_entry->quantity;?>" > </td>
												<td>
											<input type="text" name="rate_invoice[]" class="rate_invoice form-control text-center" id="rate_invoice" placeholder="Rate" onchange="Calc(this)" value="<?php echo $value_entry->rate;?>" > </td>
											<td>
...
$.ajax({
					type: 'POST',
					url: 'credit_note_sort_delete_action.php',
					data: {
		        	value : value,
        		...
        		window.location.href = 'credit_note_list.php';
