...
case 'publish':
 ...
 if ($query) {
    ...
    {
        $result2 = $db->query("INSERT INTO `repair_product_details`(`repair_id`, `product_id`, `variation_id`, `sub_variation_id`, `quantity`, `rate`, `discount`, `gst`, `amount`) VALUES ('$work_id','$product_id[$i]','$variation_id[$i]','$sub_variation_id[$i]','$quantity_invoice[$i]','$rate_invoice[$i]','$discount_invoice[$i]','$gst_invoice[$i]','$total_amount_first[$i]')");
    }
