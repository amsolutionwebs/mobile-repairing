...
<button type="button" class="btn setclose" style="background: #ea5455;" onclick="TableDelete(this,<?php echo $sales_id; ?>,<?php echo $value_repair_details->id; ?>)"> <i class="fas fa-times text-light"></i> </button>
