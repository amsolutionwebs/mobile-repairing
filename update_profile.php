...
<form class="update_profile" method="post" enctype="multipart/form-data" action="profile_action.php">
    ...
    if(!empty($profile_picture)){ ?>
        ...
        <?php }else{ ?>
        <span style="width: 100%; border:7px solid #fff;
    border-radius: 50%;
    width: 200px;
    height: 200px;
    font-size: 116px;
   ...
   <div class="col-md-6 ">
    ...
    <div class="col-md-6 ">
       ...
       <div class="form-group">
        ...
        <input type="text" name="phone" placeholder="Phone Number"  value="<?php echo $mobile_number; ?>" class="form-control" maxlength="10" minlength="10" required oninput="validateNumberInput(this)"/> </div>
      ...
      <div class="col-md-6 ">
       ...
       <div class="form-group">
        ...
        <input type="text" name="alternate_phone" placeholder="Alternate Phone Number" value="<?php echo $alternate_mobile_number; ?>" maxlength="10" minlength="10" class="form-control"  oninput="validateNumberInput(this)"/> </div>
      ...
      <div class="col-md-6 ">
       ...
       <div class="form-group">
        ...
        <input type="text" name="whatsapp_number" placeholder="Whatsapp Number" value="<?php echo $whatsapp_number; ?>" class="form-control" maxlength="10" minlength="10" oninput="validateNumberInput(this)"/> </div>
      ...
      <div class="form-group">
        <div class="custom-file">
          <label>Age</label>
            <input type="number" name="age" placeholder="Age" value="<?php echo $age; ?>" class="form-control" maxlength="2" minlength="2" required oninput="validateNumberInput(this)"/>
