              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-1">
                    <div class="d-flex justify-content-center align-items-center" style="background-color: tomato;border-radius: 50%; width: 50px; height: 50px; text-align: center;">
                      <i class="fas fas fa-users" style="font-size: 30px; color:#fff;"></i>
                    </div>
                  </div>
                  <div class="col-10">
                  
                    <h5> All User Type By Employee</h5>
                    <span>  </span>
                  </div>
                ...
                <tr>
                 ...
                 <?php
                    ...
                    $data1 = $db->query("SELECT * FROM employee_user_type");
                   ...
                   $data2 = $db->query("SELECT * FROM user_type WHERE id='$value1->user_type_id'");
                ...
                <tr>
                  ...
                  <td><?php echo $value2->user_type; ?></td>
                  ...
                  <td>
                              ...
                              <a href='employee_user_type_action.php?post=<?php echo $value1->id; ?>&action=delete' title='Delete' onClick="return confirm('Are You Sure want to delete ?')" ><button class='btn btn-xs btn-danger p-1'><i class='fas fa-trash'></i> </button></a>
